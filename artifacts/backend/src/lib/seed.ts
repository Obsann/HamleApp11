...
export async function seedIfEmpty() {
  ...
  const grade2 = await StudentModel.insertMany([
    {
      ...
      studentNo: "ST0001",
      gender: "male",
      address: "Bole Subcity, Kebele 03, Addis Ababa",
    ...
    },
    {
      ...
      studentNo: "ST0003",
      gender: "female",
      address: "Yeka Subcity, House 405, Addis Ababa",
      enrollmentStatus: "active",
      medicalInfo: null,
    ...
    },
    {
      ...
      studentNo: "ST0004",
      gender: "male",
      address: "Kirkos Subcity, Kebele 11, Addis Ababa",
      enrollmentStatus: "active",
  ...
  const grade3 = await StudentModel.insertMany([
    ...
    },
    {
      ...
      studentNo: "ST0006",
      gender: "female",
      address: "Nifas Silk Subcity, Addis Ababa",
      enrollmentStatus: "active",
  ...
  const grade4 = await StudentModel.insertMany([
    {
      ...
      studentNo: "ST0009",
      gender: "female",
      address: "Gullele Subcity, Addis Ababa",
      enrollmentStatus: "active",
      medicalInfo: null,
