...
export default function AttendanceScreen() {
  ...
  const attendanceByStudent = useMemo(() => {
    ...
    attendance?.forEach((a) => {
      ...
      curr[a.status as "present" | "absent" | "late"] += 1;
      if (!curr.latest || a.date > curr.latest) curr.latest = a.status;
              ...
              <View style={{ backgroundColor: colors.card, borderRadius: 16, padding: 16, marginBottom: 10, shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.06, shadowRadius: 8, elevation: 2 }}>
                ...
                {total > 0 ? (
                  ...
                  <View style={{ backgroundColor: colors.secondary, borderRadius: 10, paddingVertical: 8, alignItems: "center" }}>
                    <Text style={{ fontSize: 13, fontFamily: "Inter_400Regular", color: colors.mutedForeground }}>No records yet</Text>
                  </View>
                )}
              </View>
            );
